...
const db: {
  ...
  users: [
    {
      id: "u_teacher",
      name: "K. K. Rao (KKR Sir)",
      email: "teacher@kkrtuition.com",
      role: "teacher",
  ...
  students: [
    {
      ...
      parentEmail: "parent@kkrtuition.com",
  ...
  studyMaterials: [
    ...
    {
      id: "sm_4",
      title: "Quadratic Equations Masterclass Video Lesson by KKR Sir",
      class: "Class 10",
      subject: "Mathematics",
      category: "Video",
  ...
  onlineClasses: [
    {
      ...
      startTime: "18:00",
      endTime: "19:30",
      meetLink: "https://meet.google.com/kkr-tui-math",
      recordedVideoUrl: "",
      status: "upcoming"
    },
    {
      ...
      startTime: "17:00",
      endTime: "18:30",
      meetLink: "https://meet.google.com/kkr-sci-rev",
      recordedVideoUrl: "",
      status: "upcoming"
    },
    {
      ...
      startTime: "18:00",
      endTime: "19:30",
      meetLink: "https://meet.google.com/kkr-prev-class",
  ...
  notifications: [
    {
      ...
      message: "Join KKR Sir live today at 6:00 PM for Quadratic Equations board questions and doubts.",
      type: "class",
      targetRole: "all",
  ...
  gallery: [
    {
      ...
      caption: "Maximum 15 students per batch for individual focus by KKR Sir."
    },
    {
      id: "gal_2",
    ...
    },
    {
      ...
      caption: "Hands-on learning and practical physics experiments at KKR Tuition."
    },
    {
      id: "gal_4",
  ...
  testimonials: [
    {
      ...
      content: "KKR Sir's personal attention changed my daughter's score from 65% to 92% in Maths! The small batch size and daily homework checking really make a difference.",
      rating: 5,
    ...
    },
    {
      ...
      role: "Student",
      batch: "Class 10 CBSE",
      content: "KKR Sir explains complex Physics numerics and Maths formulas in very simple Telugu and English. Weekly tests prepared me completely for the board exam!",
      rating: 5,
      avatar: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150&auto=format&fit=crop&q=80"
    },
    {
...
app.get("/api/health", (req, res) => {
  res.json({ status: "ok", app: "KKR Tuition Management System" });
});
...
app.post("/api/demo-registration", (req, res) => {
  ...
  res.json({ success: true, message: "Free Demo request received! KKR Sir will contact you shortly.", demo });
});
...
app.post("/api/contact", (req, res) => {
  ...
  res.json({ success: true, message: "Thank you for contacting KKR Tuition! We will get back to you soon.", enquiry: enq });
});
...
function initializeCredentialsAndStudents() {
  ...
  for (let i = 1; i <= 50; i++) {
    ...
    db.students.push({
      ...
      email: `${studentUsername}@kkrtuition.com`,
...
function syncCredentialsFile() {
  ...
  let text = `================================================================================\n`;
  text += `KKR TUITION CLASSES (CLASSES 1-10) - MASTER CREDENTIALS DIRECTORY\n`;
  text += `================================================================================\n`;
  text += `Teacher & Founder: Dinesh_A | KKR Tuition Single-Teacher Excellence\n`;
...
app.post("/api/auth/login", (req, res) => {
  ...
  if (match) {
    let userObj: any = {
      id: match.id,
      name: match.name,
      email: match.email || `${match.username}@kkrtuition.com`,
      role: match.role,
    ...
    res.status(401).json({ error: "Invalid username, password or portal role. Check credentials.txt or ask KKR Sir." });
  }
});
...
async function startServer() {
  ...
  app.listen(PORT, "0.0.0.0", () => {
    console.log(`KKR Tuition Management System server running at http://localhost:${PORT}`);
  });
}
