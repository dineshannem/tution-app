  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      <div className="text-center space-y-3 max-w-2xl mx-auto">
        ...
        <h1 className="text-3xl font-extrabold text-slate-900 dark:text-white">Visit SSR Tuition Learning Center</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
            ...
            <div className="space-y-4 text-xs text-slate-300">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span>Mon - Sat: 04:00 PM - 08:30 PM<br />Sunday: Doubts & Special Revision</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-lg h-64 bg-slate-800 relative flex items-center justify-center p-6 text-center">
            <div className="absolute inset-0 bg-cover bg-center opacity-40" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1526778548025-fa2f459cd5c1?w=800&auto=format&fit=crop&q=80')" }} />
        ...
        <div className="lg:col-span-7 bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1 block">Your Full Name *</label>
                <input
                  type="text"
                  required
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-slate-300 dark:border-slate-700 dark:bg-slate-800 text-xs focus:ring-2 focus:ring-blue-500 outline-none"
                />
              </div>
              <div>
                <label className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1 block">Phone / Mobile Number *</label>
                <input
                  type="tel"
                  required
            ...
            <div>
              <label className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-1 block">Message Details *</label>
              <textarea
                rows={5}
                required
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs shadow-lg shadow-blue-500/20 transition-all flex items-center justify-center gap-2"
            >
              <Send className="w-4 h-4" /> {loading ? 'Sending Message...' : 'Submit Message to SSR Sir'}
            </button>
          </form>
        </div>
      </div>
